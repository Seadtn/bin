<%@ Page Title="" Language="C#" MasterPageFile="~/agents/agent.Master" AutoEventWireup="true" CodeFile="Footballeurs.aspx.cs" Inherits="OdinESport.agents.Footballeurs" %>
...
<%--                                <input type="text" class="form-control" name="fname" id="fname" placeholder="Age" runat="server"/>--%>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="form-label">Country: </label>
                                  <asp:TextBox ID="country" class="form-control" placeholder="Country" runat="server"></asp:TextBox>

<%--                                <input type="text" class="form-control" name="lname" id="lname" placeholder="Country" runat="server"/>--%>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
...
<%--                    <button type="button" name="next" class="btn btn-primary next action-button float-end" runat="server" OnClick="SearchButton_Click">Search</button>--%>
         ...
         <div class="card">
            ...
            <div class="card-body px-0">
               <div class="table-responsive">
                ...
                <%--  <table id="user-list-table" class="table table-striped" role="grid" runat="server" data-toggle="data-table">
                     <thead>
                        <tr class="ligth">
                           <th>Profile</th>
                           <th>Age</th> 
