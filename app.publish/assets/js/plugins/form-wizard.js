(function () {
    ...
    const ActiveTab=(n)=>{
        ...
        if(n==1){
            ...
            document.getElementById("personal").classList.remove("done");
            document.getElementById("football").classList.remove("done");
            document.getElementById("football").classList.remove("active");
        ...
        if(n==3){
            ...
            document.getElementById("football").classList.add("done");
