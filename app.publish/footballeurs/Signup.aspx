﻿<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Signup.aspx.cs" MaintainScrollPositionOnPostBack="true" Inherits="OdinESport.footballeurs.Signup" %>
                                ...
                                <div class="card-body">
                                    ...
                                    <form id="formwizard1" class="mt-3 text-center" runat="server">
                                        <ul id="top-tab-list" class="p-0 row list-inline">
                                            <li class="mb-2 col-lg-1 col-md-6"></li>
                                            <li class="mb-2 col-lg-2 col-md-6 text-start active" id="account">
                                            ...
                                            <li id="personal" class="mb-2 col-lg-2 col-md-6 text-start">
                                                <a href="javascript:void();">
                                                    <div class="iq-icon me-3">
                                                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="20" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            <li id="football" class="mb-2 col-lg-2 col-md-6 text-start">
                                                <a href="javascript:void();">
                                                    <div class="iq-icon me-3">
                                                        <svg class="icon-32" width="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg">
                                                    ...
                                                    <span class="dark-wizard">Football</span>
                                                </a>
                                            </li>
                                            <li id="payment" class="mb-2 col-lg-2 col-md-6 text-start">
                                                <a href="javascript:void();">
                                                    <div class="iq-icon me-3">
                                                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="20" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                            ...
                                            <li id="confirm" class="mb-2 col-lg-2 col-md-6 text-start">
                                                <a href="javascript:void();">
                                                    <div class="iq-icon me-3">
                                                        <svg class="svg-icon" xmlns="http://www.w3.org/2000/svg" height="20" width="20" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        ...
                                        <fieldset>
                                            <div class="form-card text-start">
                                                <div class="row">
                                                    <div class="col-7">
                                                        <h3 class="mb-4">Football Information:</h3>
                                                    </div>
                                                    <div class="col-5">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <asp:RadioButtonList ID="foot" runat="server">
                                                                <asp:ListItem Text="Left" Value="Left" Inline="True" />
                                                                <asp:ListItem Text="Right" Value="Right" Inline="True" />
                                                                <asp:ListItem Text="Both" Value="Both" Inline="True" />
                                                            </asp:RadioButtonList>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
